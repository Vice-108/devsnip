...
<script lang="ts" setup>
	...
	watch(() => [props.number, props.minDelay, props.maxDelay, props.minDuration, props.maxDuration, props.angle], setStyles);

	const localStyles = tv({
		slots: {
			wrapper: "animate-meteor pointer-events-none absolute size-0.5 rotate-[var(--angle)] rounded-full bg-zinc-500 shadow-[0_0_0_1px_#ffffff10]",
