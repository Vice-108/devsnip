<template>
	<UiSheetPortal :to="to">
		...
		<DialogContent data-slot="sheet-content" :class="styles({ side, isBlurred, class: props.class })" v-bind="{ ...forwarded, ...$attrs }">
			<slot>
				<slot name="header">
					<UiSheetHeader>
						<slot name="title">
...
<script lang="ts" setup>
	...
	const forwarded = useForwardPropsEmits(reactiveOmit(props, "icon", "title", "description", "class", "to", "side", "isBlurred"), emits);
